...
class Autochek(scrapy.Spider):
    ...
    start_urls = ["https://autochek.africa/ke/cars-for-sale?country=ke&page_number=1"]
    ...
    def product_detail(self, response):
        ...
        if not car or car == "":
            ...
            output = {
                ...
                "price_wholesale": float(car.get("marketplacePrice")),
                "currency": page_props.get("country").get("currency"),
            }

            if page_props.get("country").get("country") == "Kenya":
                output["country"] = "KE"
