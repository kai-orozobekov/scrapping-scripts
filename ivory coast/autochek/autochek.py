...
class Autochek(scrapy.Spider):
    ...
    start_urls = [
        "https://autochek.africa/en/ci/cars-for-sale?country=ci&page_number=1"
    ]
    ...
    def product_detail(self, response):
        ...
        if not car or car == "":
            ...
            output["country"] = page_props.get("country").get("countryCode")
            ...
            if inspection_report is not None and inspection_report != {}:
            ...
            output["drive_train"] = car.get("model").get("wheelType")
