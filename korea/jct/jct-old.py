...
class JpcartradeSpider(scrapy.Spider):
    ...
    def start_requests(self):
        url = "https://www.japanesecartrade.com/stock_list.php?make_id=&maker_id=&mfg_from=&month_from=&mfg_to=&month_to=&fuel_id=&seat_capacity=&transmission_id=&type_id=&subtype_id=&drive=&mileage_from=&mileage_to=&price_from=&price_to=&cc_from=&cc_to=&wheel_drive=&color_id=&stock_country=south+korea&search_keyword=&SA=make&isSearched=1&sort=&desksearch=desksearch&seq="
    ...
    async def detail(self, response):
        ...
        if price:
            ...
            output["price_wholesale"] = float(price)
            output["currency"] = "USD"
